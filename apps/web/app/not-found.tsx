    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-blue-50/70 to-slate-50 px-5 py-10 sm:px-6">
      <section className="w-full max-w-xl overflow-hidden rounded-3xl border border-blue-100 bg-white text-center shadow-xl shadow-blue-950/5">
        ...
        <div className="p-8 sm:p-12">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border-4 border-blue-100 bg-blue-50 text-2xl font-black text-blue-700">
            404
          </div>

          <p className="mt-7 text-sm font-bold uppercase tracking-[0.25em] text-blue-700">
          ...
          <p className="mt-5 leading-relaxed text-slate-600">
            O endereço acessado pode estar incorreto ou o conteúdo não está mais
            disponível.
          </p>
